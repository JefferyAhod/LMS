...
//The cols has to be set to 'auto' as in;  'grid grid-cols-auto' so check the index.css file 

  return (
    <div className='py-16 md:px-40 px-8'>
        <h2 className='text-3x1 font-medium text-gray-800'>Learn from the best</h2>
        <p className='text-sm md:text-base text-gray-500 
        mt-3'>Discover our top-rated coursees across various 
        categories. From coding and design to business and wellness,
