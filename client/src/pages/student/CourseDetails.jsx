...
const {allCourses, calculateRating, calculateChapterTime, calculateNoOfLectures, 
  ...
  return courseData ? (
    ...
    justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
      ...
      bg-gradient-to-b from-cyan-100/70'></div>
       ...
       {/* left column 
       this part, the text-course-details-heading-large and text-course-details-heading-small
       parts should use a particular font size defined in the tailwind.config.js file */}
...
<div className='flex items-center space-x-2 pt-3 pb-1 text-sm'>
       ...
       md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]'>
        ...
        <div className='p-5'>
          <div className='flex items-center gap-2'>
              <img className='w-3.5' src={assets.time_clock_icon} alt="time 
              left clock icon"/>
          ...
          <div className='flex gap-3 items-center pt-2'>
            ...
            <p className='md:text-lg text-gray-500'>{courseData.discount}% 0ff</p>
          </div>
...
// This line is supposed to give a backgraound color in the coursedetails page, but it doesn't 
// because of the tailwind.config.css.js file not being available
// <div className='absolute top-0 left-0 w-full h-section-height -z-1
//       bg-gradient-to-b from-cyan-100/70'></div>